...
class ValidateBacktesterGuardrail:
    ...
    def _validate_backtest_on_strategy(self, task_output: TaskOutput) -> Tuple[bool, Any]:
        ...
        start_date = parse_yyyy_mm_dd(self._backtester.prices.dataset_start_date) + timedelta(days=1)
        end_date = parse_yyyy_mm_dd(self._backtester.prices.dataset_end_date)
